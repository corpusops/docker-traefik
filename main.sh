...
SKIPPED_TAGS="$SKIPPED_TAGS|v?1\.[0-9]$"
...
library/traefik/alpine\
 library/traefik/1.7-alpine\
 library/traefik/2.0\
 library/traefik/2.0-alpine\
 library/traefik/v2.0\
 library/traefik/v2.2\
 library/traefik/v2.4\
 library/traefik/2.4::10
"
