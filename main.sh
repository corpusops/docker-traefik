...
TRAEFIK_SKIPPED_TAGS="traefik:(v?1|.*(v?[0-9]+\.[0-9]+\.?|rocamadour|beaufort|epoisses|vacherin|rc|nano|windows|camembert|cancoillotte|cantal|chevrotin|comte|faisselle|livarot|maroilles|mimolette|montdor|morbier|picodon|raclette|reblochon|roquefort|tetedemoine|brie|banon).*)"
SKIPPED_TAGS="$TRAEFIK_SKIPPED_TAGS"

# (see docker-elasticsearch for example on how to use)
PROTECTED_VERSIONS="traefik:(v?(2\.11|3\.1)(-alpine)?$)"
default_images="
library/traefik
"
...
library/traefik/latest\
 library/traefik/alpine::30
library/traefik/3\
 library/traefik/3.1\
 library/traefik/v3.1\
 library/traefik/v3::30
library/traefik/v2\
 library/traefik/2\
 library/traefik/v2.11\
 library/traefik/2.11::30
"
